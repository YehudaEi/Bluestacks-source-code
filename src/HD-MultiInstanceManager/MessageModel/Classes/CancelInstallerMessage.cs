...
// Type: MultiInstanceManagerMVVM.MessageModel.Classes.CancelInstallerMessage
...
{
  public class CancelInstallerMessage
  {
    public bool IsDownLoadCanceled { get; set; }

    public bool IsCancelledBeforeDownload { get; set; }
  }
}
