...
namespace BlueStacks.Common
{
  public static class Assets
  {
    ...
    public static class Sidebar
    {
      ...
      public const string InstallApk = "sidebar_installapk";
      ...
      public const string FarmModeActive = "sidebar_farmmode_active";
      public const string FarmModeInactive = "sidebar_farmmode_inactive";
      public const string UtcConverter = "sidebar_utc_converter";
    }
