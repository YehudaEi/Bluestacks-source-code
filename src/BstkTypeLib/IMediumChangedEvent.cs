...
// Type: BstkTypeLib.IMediumChangedEvent
...
{
  [Guid("635D8F36-E3B7-4EDB-8B78-3A983486BD69")]
  [TypeLibType(20544)]
  [ComImport]
  public interface IMediumChangedEvent : IEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610809344)]
    IMediumAttachment MediumAttachment { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
