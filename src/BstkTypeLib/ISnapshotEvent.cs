...
// Type: BstkTypeLib.ISnapshotEvent
...
{
  [Guid("2D6B672B-C5D8-4B44-8179-057947C22603")]
  [TypeLibType(20544)]
  [ComImport]
  public interface ISnapshotEvent : IMachineEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610874880)]
    string SnapshotId { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  }
}
