...
// Type: BstkTypeLib.IGuestFileStateChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("6C7E4FEE-8ABA-4ED7-ADA5-D0B59E0B6027")]
  [ComImport]
  public interface IGuestFileStateChangedEvent : IGuestFileEvent
  {
    ...
    [DispId(1610940416)]
    FileStatus Status { [DispId(1610940416), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("BstkTypeLib.FileStatus")] get; }

    [DispId(1610940417)]
    IVirtualBoxErrorInfo Error { [DispId(1610940417), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
