...
// Type: BstkTypeLib.IMachineStateChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("3A475DE1-7F26-4FCC-BDDE-A7762AE3458E")]
  [ComImport]
  public interface IMachineStateChangedEvent : IMachineEvent
  {
    [DispId(1610743808)]
    ...
    MachineState State { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("BstkTypeLib.MachineState")] get; }
  }
}
