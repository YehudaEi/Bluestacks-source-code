...
// Type: BstkTypeLib.IGuestProcessEvent
...
{
  [Guid("C3C50BE8-D729-4098-9481-C96FA62B0020")]
  [TypeLibType(20544)]
  [ComImport]
  public interface IGuestProcessEvent : IGuestSessionEvent
  {
    ...
    [DispId(1610874880)]
    IGuestProcess Process { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

    [DispId(1610874881)]
    uint PID { [DispId(1610874881), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
