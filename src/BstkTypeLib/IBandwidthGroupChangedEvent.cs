...
// Type: BstkTypeLib.IBandwidthGroupChangedEvent
...
{
  [Guid("EBFEFCBA-9836-4269-BDF6-B75A2C8F9F12")]
  [TypeLibType(20544)]
  [ComImport]
  public interface IBandwidthGroupChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    IBandwidthGroup BandwidthGroup { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
