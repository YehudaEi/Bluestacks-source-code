...
// Type: BstkTypeLib.IGuestPropertyChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("DF4D85EC-755A-4CD4-A947-07B2035835B6")]
  [ComImport]
  public interface IGuestPropertyChangedEvent : IMachineEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610874880)]
    string Name { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

    [DispId(1610874881)]
    string Value { [DispId(1610874881), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

    [DispId(1610874882)]
    string Flags { [DispId(1610874882), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  }
}
