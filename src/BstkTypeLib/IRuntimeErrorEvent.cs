...
// Type: BstkTypeLib.IRuntimeErrorEvent
...
{
  [TypeLibType(20544)]
  [Guid("21758A74-E2B6-4593-85E6-2EF564F8B778")]
  [ComImport]
  public interface IRuntimeErrorEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    int Fatal { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

    [DispId(1610809345)]
    string Id { [DispId(1610809345), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

    [DispId(1610809346)]
    string Message { [DispId(1610809346), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  }
}
