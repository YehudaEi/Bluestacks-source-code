...
// Type: BstkTypeLib.IStorageDeviceChangedEvent
...
{
  [Guid("837286CC-5A8D-4017-9086-658E053CBBB3")]
  [TypeLibType(20544)]
  [ComImport]
  public interface IStorageDeviceChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    IMediumAttachment StorageDevice { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

    [DispId(1610809345)]
    int Removed { [DispId(1610809345), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

    [DispId(1610809346)]
    int Silent { [DispId(1610809346), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
