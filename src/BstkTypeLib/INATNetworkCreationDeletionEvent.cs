...
// Type: BstkTypeLib.INATNetworkCreationDeletionEvent
...
{
  [Guid("107F2A30-0FF9-43A9-9BAA-964694EDEC58")]
  [TypeLibType(20544)]
  [ComImport]
  public interface INATNetworkCreationDeletionEvent : INATNetworkAlterEvent
  {
    ...
    [DispId(1610940416)]
    int CreationEvent { [DispId(1610940416), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
