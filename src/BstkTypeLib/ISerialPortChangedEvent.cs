...
// Type: BstkTypeLib.ISerialPortChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("1E7C98EA-E716-4743-AAB2-DA78F8292813")]
  [ComImport]
  public interface ISerialPortChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    ISerialPort SerialPort { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
