...
// Type: BstkTypeLib.INATNetworkChangedEvent
...
{
  [Guid("DDE15A40-4DB7-4912-B8C6-893EF268092C")]
  [TypeLibType(20544)]
  [ComImport]
  public interface INATNetworkChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    string NetworkName { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
  }
}
