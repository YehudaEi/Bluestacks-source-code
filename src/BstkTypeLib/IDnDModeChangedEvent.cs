...
// Type: BstkTypeLib.IDnDModeChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("892E8B06-4FB9-4CD1-88D6-2C59F046AB1A")]
  [ComImport]
  public interface IDnDModeChangedEvent : IEvent
  {
    [DispId(1610743808)]
    ...
    DnDMode DnDMode { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("BstkTypeLib.DnDMode")] get; }
  }
}
