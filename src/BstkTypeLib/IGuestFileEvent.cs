...
// Type: BstkTypeLib.IGuestFileEvent
...
{
  [TypeLibType(20544)]
  [Guid("22538E23-C872-480C-A376-A4F05D7211B1")]
  [ComImport]
  public interface IGuestFileEvent : IGuestSessionEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610874880)]
    IGuestFile File { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
