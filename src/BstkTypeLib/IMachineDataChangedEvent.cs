...
// Type: BstkTypeLib.IMachineDataChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("F939F90B-8757-4B1D-AE7E-84BF7C7E482F")]
  [ComImport]
  public interface IMachineDataChangedEvent : IMachineEvent
  {
    ...
    [DispId(1610874880)]
    int Temporary { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
