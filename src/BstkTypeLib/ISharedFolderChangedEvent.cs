...
// Type: BstkTypeLib.ISharedFolderChangedEvent
...
{
  [Guid("00C5625F-47B7-4460-B937-CED55D2141DF")]
  [TypeLibType(20544)]
  [ComImport]
  public interface ISharedFolderChangedEvent : IEvent
  {
    [DispId(1610743808)]
    ...
    [ComAliasName("BstkTypeLib.Scope")]
    [DispId(1610809344)]
    Scope Scope { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: ComAliasName("BstkTypeLib.Scope")] get; }
  }
}
