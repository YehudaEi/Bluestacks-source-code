...
// Type: BstkTypeLib.INATNetworkStartStopEvent
...
{
  [TypeLibType(20544)]
  [Guid("082EA2F3-9B3F-4BE1-82E8-5A134D5F2771")]
  [ComImport]
  public interface INATNetworkStartStopEvent : INATNetworkChangedEvent
  {
    ...
    [DispId(1610874880)]
    int StartEvent { [DispId(1610874880), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
