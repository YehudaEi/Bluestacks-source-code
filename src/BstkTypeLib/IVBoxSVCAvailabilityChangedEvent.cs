...
// Type: BstkTypeLib.IVBoxSVCAvailabilityChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("5DB7702E-0125-4713-92DC-215E2B636DE6")]
  [ComImport]
  public interface IVBoxSVCAvailabilityChangedEvent : IEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610809344)]
    int Available { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
