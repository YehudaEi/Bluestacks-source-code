...
// Type: BstkTypeLib.IGuestKeyboardEvent
...
{
  [TypeLibType(20544)]
  [Guid("8A7ACE32-4902-44C3-93EC-810203FC16BC")]
  [ComImport]
  public interface IGuestKeyboardEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    int[] Scancodes { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_I4)] get; }
  }
}
