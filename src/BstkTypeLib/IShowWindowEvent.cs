...
// Type: BstkTypeLib.IShowWindowEvent
...
{
  [Guid("DAB1273C-F655-45A1-8BA4-AD5A8D7D5106")]
  [TypeLibType(20544)]
  [ComImport]
  public interface IShowWindowEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    long WinId { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }
  }
}
