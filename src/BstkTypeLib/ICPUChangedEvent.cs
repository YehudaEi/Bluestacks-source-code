...
// Type: BstkTypeLib.ICPUChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("ED325417-670B-4ADE-9B49-F6A19530235E")]
  [ComImport]
  public interface ICPUChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    uint CPU { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
