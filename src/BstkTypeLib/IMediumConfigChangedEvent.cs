...
// Type: BstkTypeLib.IMediumConfigChangedEvent
...
{
  [TypeLibType(20544)]
  [Guid("D1AE1BF9-D10F-40CD-A4CA-DD909AF87E3C")]
  [ComImport]
  public interface IMediumConfigChangedEvent : IEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610809344)]
    IMedium Medium { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
