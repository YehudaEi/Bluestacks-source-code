...
// Type: BstkTypeLib.IGuestProcessIOEvent
...
{
  [TypeLibType(20544)]
  [Guid("600156D0-3789-4E53-BF0C-6BE31A784D43")]
  [ComImport]
  public interface IGuestProcessIOEvent : IGuestProcessEvent
  {
    [DispId(1610743808)]
    ...
    [DispId(1610940416)]
    uint Handle { [DispId(1610940416), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
