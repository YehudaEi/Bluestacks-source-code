...
// Type: BstkTypeLib.INetworkAdapterChangedEvent
...
{
  [Guid("F2C8B789-B633-4630-BEBB-A924AA55003E")]
  [TypeLibType(20544)]
  [ComImport]
  public interface INetworkAdapterChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    INetworkAdapter NetworkAdapter { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
  }
}
