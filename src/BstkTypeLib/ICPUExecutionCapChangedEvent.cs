...
// Type: BstkTypeLib.ICPUExecutionCapChangedEvent
...
{
  [Guid("938762A7-55D2-420E-B3F7-E3E7C22935C1")]
  [TypeLibType(20544)]
  [ComImport]
  public interface ICPUExecutionCapChangedEvent : IEvent
  {
    ...
    [DispId(1610809344)]
    uint ExecutionCap { [DispId(1610809344), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
